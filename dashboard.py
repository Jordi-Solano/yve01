...
<div class="main">
  ...
  <!-- PANEL F&B COST CONTROL -->
  <div id="panel-fb" class="panel">
    <div id="fb-tab-content">
      <div class="empty"><div class="ei">⏳</div><p>Cargando módulo F&amp;B...</p></div>
    </div>
  </div><!-- /panel-fb -->
...
async function loadFBTab() {
  const cont = document.getElementById('fb-tab-content');
...
async function ejecutarFBPipeline() {
