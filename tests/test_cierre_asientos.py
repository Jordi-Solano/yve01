...
def main():
    ...
    ok(res['fuentes'] == {'ap': 3, 'ar_ota': 1, 'ventas_fb': 2, 'ar_facturas': 2, 'ar_cobros': 0, 'banco': 2, 'caja': 0, 'caja_descuadres': 0, 'provisiones': 1, 'compensaciones': 0}, f"fuentes: {res['fuentes']}")
