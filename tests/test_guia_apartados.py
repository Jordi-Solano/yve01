...
PANELES = {
    ...
    'panel-ar': (['s-tot', 's-imp', 's-ok', 's-disc', 's-disc-sub', 's-di', 's-pend', 's-pend-sub', 'ota-chart', 'activity', 'tbl-count', 'ar-select-all', 'tbl-body', 'ar-recl-section', 'ar-recl-resumen', 'ar-recl-list', 'btn-export-selected'],
                 ["toggleSelectAll(this,'ar-row-cb')", 'exportarSeleccionados()', 'href="/aprobaciones-ar/"'], 0),   # b85: seccion dentro de AP, el primario es el de AP
    ...
    # b87: el grid clientes|facturas se reparte en tres subpestañas (Contratos · Peticion de credito · Aging AR)
    'panel-ar_real': (['ar-real-stats', 'arp-pendiente', 'arp-vencido', 'arp-cobrado', 'arp-nclientes', 'ar-subtabs', 'ar-sub-contratos', 'ar-sub-credito', 'ar-sub-aging', 'ar-contratos-list', 'ar-contratos-count', 'ar-contratos-resumen', 'ar-clientes-list', 'ar-facturas-count', 'ar-filter-estado', 'ar-aging-bar', 'ar-facturas-tbody', 'modal-emitir', 'ef-cliente', 'ef-entrada', 'ef-salida', 'ef-hab', 'ef-precio', 'ef-fb', 'ef-sub-hab', 'ef-sub-fb', 'ef-iva', 'ef-total', 'ef-msg', 'ar-bonos-section', 'ar-bonos-resumen', 'ar-bonos-list', 'ar-credito-section', 'ar-credito-list', 'ar-real-status'],
                      ['abrirEmitirFactura()', 'loadARRealData()', 'abrirNuevoCliente()', 'filtrarFacturasAR(this.value)', 'calcularFactura()', 'emitirFactura()', 'cerrarEmitirFactura()', 'href="/aprobaciones-ar/"', "arSub('contratos',this)", "arSub('credito',this)", "arSub('aging',this)"], 2),
    'panel-cierre': (['cierre-mes', 'cierre-hotel', 'cierre-stats', 'cierre-k-asientos', 'cierre-k-debe', 'cierre-k-haber', 'cierre-k-cuadre', 'cierre-avisos', 'paq-estado', 'paq-body', 'paq-resultado', 'cierre-recon-body', 'cbanco-saldo', 'cbanco-pestanas', 'cbanco-body', 'inv-resumen', 'inv-body', 'fis-estado', 'fis-resumen', 'fis-body', 'inm-resumen', 'inm-form', 'inm-desc', 'inm-cat', 'inm-fecha', 'inm-coste', 'inm-vida', 'inm-doc', 'inm-body', 'cierre-mayor-body', 'cierre-diario-body'],
                     ['loadCierre(true)', '_inmForm()', '_inmGuardar()'], 1),   # b103: fuera "Subir recuento"
