...
PANELES = {
    ...
    'panel-ar_real': (['ar-real-stats', 'arp-pendiente', 'arp-vencido', 'arp-cobrado', 'arp-nclientes', 'ar-subtabs', 'ar-sub-contratos', 'ar-sub-credito', 'ar-sub-aging', 'ar-contratos-list', 'ar-contratos-count', 'ar-contratos-resumen', 'ar-clientes-list', 'ar-facturas-count', 'ar-filter-estado', 'ar-aging-bar', 'ar-facturas-tbody', 'modal-emitir', 'ef-cliente', 'ef-entrada', 'ef-salida', 'ef-hab', 'ef-precio', 'ef-fb', 'ef-sub-hab', 'ef-sub-fb', 'ef-iva', 'ef-total', 'ef-msg', 'ar-bonos-section', 'ar-bonos-resumen', 'ar-bonos-list', 'ar-beos-section', 'ar-beos-count', 'ar-beos-list', 'ar-real-status'],
