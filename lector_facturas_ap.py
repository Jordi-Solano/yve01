...
def extraer_con_claude(texto, nombre_archivo):
    ...
    try:
        ...
        prompt = (
            ...
            "items:[{ingrediente, categoria, coste_unitario, stock_actual_kg_l, unidad}] (todos los productos)\n\n"
            "Si MERMAS → JSON con: tipo_documento:\"MERMAS\", "
            "items:[{fecha, ingrediente, categoria, cantidad_merma, unidad, causa, coste_merma}], total_mermas\n\n"
            "Si VENTAS_POS → JSON con: tipo_documento:\"VENTAS_POS\", "
            "fecha, total_ventas, num_tickets, "
            "platos:[{nombre_plato, categoria, unidades_vendidas, total_venta}]\n\n"
