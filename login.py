...
<body>
<script>
// b105: la intro (el logo que se enciende, una vez por sesion) es la del panel. Este login
// tenia su propio splash viejo (1,9 s, con rueda de "cargando") y ademas marcaba la intro
// como VISTA: despues de entrar, el panel se la saltaba e iba directo. Ahora el login no
// tiene splash y borra la marca: al entrar, el panel enseña la intro.
(function(){
  try{ sessionStorage.removeItem('yve_splash_shown'); }catch(e){}
  ...
  <div class="login-card">
    ...
    <div style="text-align:center;margin-top:12px;font-size:11px;color:#475569">
      <div style="display:flex;justify-content:center;gap:12px;margin-bottom:8px">
        <button onclick="setLoginLang('es')" data-lang="es" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Español" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">ES</button>
        <button onclick="setLoginLang('en')" data-lang="en" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="English" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">EN</button>
        <button onclick="setLoginLang('ca')" data-lang="ca" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Català" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">CAT</button>
        <button onclick="setLoginLang('fr')" data-lang="fr" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Français" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">FR</button>
        <button onclick="setLoginLang('de')" data-lang="de" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Deutsch" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">DE</button>
        <button onclick="setLoginLang('it')" data-lang="it" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Italiano" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">IT</button>
        <button onclick="setLoginLang('pt')" data-lang="pt" style="background:none;border:none;cursor:pointer;font-size:12px;font-weight:800;letter-spacing:.5px;color:#94a3b8;opacity:.7;transition:.15s;padding:2px 4px;font-family:inherit" title="Português" onmouseover="this.style.opacity=1;this.style.color='#60a5fa'" onmouseout="this.style.opacity=.7;this.style.color='#94a3b8'">PT</button>
      </div>
    </div>
    <div class="demo">
